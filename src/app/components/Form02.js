                ...
                <form action="#" className="form">
                    <div className="col-md-6">
                        ...
                        <div className="mainOptions">
                            ...
                            <Select nameSelect={"chooserСirculation_form2"}/>
                            <Select nameSelect={"chooserFormat_form2"}/>
                            <Select nameSelect={"chooserNumberSheets_form2"}/>
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="extendOptions__wrapper">
                            ...
                            <Checkbox nameCheckbox={"color_form2"}/>
                            <Checkbox nameCheckbox={"cmyk_form2"}/>
                            <Checkbox nameCheckbox={"varnish_form2"}/>
